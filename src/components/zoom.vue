...
<template>
  <div>
    <div style="float:left;"><save></save></div>
    <div style="float:right">
      <history ></history>
      <ButtonGroup>
        <Button @click="big" size="small">
          <svg
            t="1650853919128"
            class="icon"
        ...
        <Button @click="rSet" size="small">1:1</Button>
        <Button @click="setViewport" icon="md-resize" size="small"></Button>
      </ButtonGroup>
    </div>
  </div>
</template>
